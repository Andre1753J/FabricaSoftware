    ...
    return (
        <main className={styles.main}>
            <div className={styles.card_primeiro}>
                ...
                <a href="telaAdocao.html"><button className={styles.adt}>Adote</button></a>
            </div>
            <div className={styles.card_segundo}>
                ...
                <div className={styles.card_link}>
                    <a href="https://www.whatsapp.com"><img className={styles.wts} src="/whatsapp_256_black.png" alt="WhatsApp" /></a>
                    <a href="https://www.instagram.com"><img className={styles.itg} src="/instagram-logo-instagram-logo-transparent-instagram-icon-transparent-free-free-png.webp" alt="Instagram" /></a>
                </div>
            </div>
        </main>
    );
